...
const Hotel = () => {
  ...
  const { data, loading, error } = useFetch(`https://boovago-ljor.onrender.com/api/v1/hotels/find/${hotelid}`)
  console.log(data)
        ...
        <div className="HotelWrapper">
          ...
          <div className="hotelTitle">
            <div className="titleLeft">
              ...
              <div className="address"><FontAwesomeIcon icon={faLocationDot} /> {data.address} <span>地理位置超棒－{data.distance}.顯示地圖</span></div>
            </div>
          ...
          <div className="hotelImgWrapper">
            ...
            <div className="hotelImg">
              {data.photos?.slice(0, 6).map((item, i) => //如果有到7張照片就可以觀看更多並往上加
                i >= 5 ?
